...
class Judge:
    ...
    async def judge(self, prompt_file: Path, image_dir_1: Path, image_dir_2: Path, output_file: Path) -> None:
        ...
        try:
            ...
            duel_results = {}
            for prompt_key, result in zip(prompt_keys, results, strict=False):
    ...
    async def _process_prompt(
        ...
        *,
        ...
        try:
            ...
            # Get file 1 image
            with file_1.open("rb") as f:
                file_1_image = f.read()
            # Get file 2 image
            with file_2.open("rb") as f:
                file_2_image = f.read()
    ...
    async def ask_judge(
        ...
        async with process_sem:
            ...
            messages = [
                {"role": "system", "content": SYSTEM_PROMPT},
                {
                    ...
                    "content": [
                        ...
                        {"type": "image_url", "image_url": {"url": f"data:image/png;base64,{left_img_b64}"}},
            ...
            if content is None:
                raise ValueError("Received None content from judge API")
